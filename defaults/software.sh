...
DROPBEAR_VER="${DROPBEAR_VER:-VERSION_DROPBEAR}"
DROPBEAR_DIR="${DROPBEAR_DIR:-dropbear-${DROPBEAR_VER}}"
DROPBEAR_SRCTAR="${DROPBEAR_SRCTAR:-${DISTDIR}/dropbear-${DROPBEAR_VER}.tar.bz2}"
DROPBEAR_BINCACHE="${DROPBEAR_BINCACHE:-%%CACHE%%/dropbear-${DROPBEAR_VER}-%%ARCH%%.bz2}"
